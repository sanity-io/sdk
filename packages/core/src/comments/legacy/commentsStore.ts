 ...
 * the published id whether or not drafts exist. `collaboration` selects the
 * organization store, which this add-on dataset path never reads.
 */
type CommentsKeyIrrelevantField = 'source' | 'liveEdit' | 'collaboration'
