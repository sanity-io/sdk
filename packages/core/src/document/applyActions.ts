...
/** @beta */
export function applyActions(
  ...args: Parameters<typeof boundApplyActions>
): ReturnType<typeof boundApplyActions> {
  return boundApplyActions(...args)
}

const boundApplyActions = bindActionByDataset(documentStore, _applyActions)

/** @internal */
async function _applyActions(
  ...
  if (
    ...
    return boundApplyActions(matchedInstance, actionOrActions, {
      disableBatching,
      transactionId,
    })
  }
