 ...
 * @returns An object containing the projection results (`data`) and loading state (`isPending`). Note: Suspense handles initial loading states; `data` being `undefined` after suspense means the document doesn't exist or the projection yielded no result.
 */
