...
/**
 * Parameters for the useIntentButton hook
 * @public
 */
interface UseIntentButtonParams {
  intentName?: string
...
/**
 * Return type for the useIntentButton hook
 * @public
 */
 ...
 * @example
 * ```tsx
 * import {useIntentButton} from '@sanity/sdk-react'
 * import {Button} from '@sanity/ui'
 * import {Suspense} from 'react'
 *
 * function IntentButton({documentId, documentType, projectId, dataset}) {
...
export function useIntentButton({
  ...
  documentHandle,
  params,
}: UseIntentButtonParams): IntentButton {
