...
// import {useTranslation} from '../../../i18n' // unclear whether we're bringing this to SDK
 ...
 * @hidden
 * @beta */
export function DefaultPreviewLayout(props: DefaultPreviewProps) {
          ...
          >
            ...
            {!title && (
              <span style={{color: 'var(--card-muted-fg-color)'}}>
                {/* {t('preview.default.title-fallback')} see above note */}
                Untitled
              </span>
            )}
          </Text>
